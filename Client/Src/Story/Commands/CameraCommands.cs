  ...
  internal class CameraLookatCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      if (m_ParamNum >= 3) {
        ...
        LogSystem.Debug("CameraLookat:{0} {1} {2}", x, y, z);
      } else if (m_ParamNum >= 1) {
        ...
        if (null != npc) {
          ...
          LogSystem.Debug("CameraLookat:{0}({1} {2} {3})", unitId, msi.PositionX, msi.PositionY, msi.PositionZ);
        }
      } else {
        ...
        if (null != user) {
          ...
          GfxSystem.SendMessage("GfxGameRoot", "CameraLookat", new float[] { msi.PositionX, msi.PositionY, msi.PositionZ });
          LogSystem.Debug("CameraLookat:playerself({0} {1} {2})", msi.PositionX, msi.PositionY, msi.PositionZ);
        }
      }
      return false;
    }
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      if (0 == m_ParamNum) {
        ...
        if (null != view) {
          ...
          LogSystem.Debug("CameraFollow:{0}", view.Actor);
        }
      } else {
        int unitId = m_UnitId.Value;
        NpcInfo npc = WorldSystem.Instance.GetCharacterByUnitId(unitId) as NpcInfo;
  ...
  internal class CameraLookatImmediatelyCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      if (m_ParamNum >= 3) {
        ...
        LogSystem.Debug("CameraLookatImmediately:{0} {1} {2}", x, y, z);
      } else if (m_ParamNum >= 1) {
        int unitId = m_UnitId.Value;
        NpcInfo npc = WorldSystem.Instance.GetCharacterByUnitId(unitId) as NpcInfo;
        if (null != npc) {
          ...
          LogSystem.Debug("CameraLookatImmediately:{0}({1} {2} {3})", unitId, msi.PositionX, msi.PositionY, msi.PositionZ);
        }
      } else {
        UserInfo user = WorldSystem.Instance.GetPlayerSelf();
        if (null != user) {
          MovementStateInfo msi = user.GetMovementStateInfo();
          GfxSystem.SendMessage("GfxGameRoot", "CameraLookatImmediately", new float[] { msi.PositionX, msi.PositionY, msi.PositionZ });
          LogSystem.Debug("CameraLookatImmediately:playerself({0} {1} {2})", msi.PositionX, msi.PositionY, msi.PositionZ);
        }
      }
      return false;
    }
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      if (0 == m_ParamNum) {
        ...
        if (null != view) {
          ...
          LogSystem.Debug("CameraFollowImmediately:{0}", view.Actor);
        }
      } else {
        int unitId = m_UnitId.Value;
        NpcInfo npc = WorldSystem.Instance.GetCharacterByUnitId(unitId) as NpcInfo;
