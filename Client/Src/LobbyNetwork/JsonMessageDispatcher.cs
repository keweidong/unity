...
namespace DashFire.Network
{
  ...
  internal class JsonMessageDispatcher
  {
    ...
    internal static unsafe void HandleNodeMessage(string msgStr)
    {
      if (s_Inited) {
    ...
    internal static bool SendMessage(int id, JsonData jsonData)
    {
    ...
    internal static bool SendMessage(JsonMessage msg)
    {
