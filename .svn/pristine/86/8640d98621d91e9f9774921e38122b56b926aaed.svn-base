...
namespace TestStory.Commands
{
  ...
  /// disconnectlobby();
  /// </summary>
  internal class DisconnectLobbyCommand : AbstractStoryCommand
  {
    public override IStoryCommand Clone()
    {
      DisconnectLobbyCommand cmd = new DisconnectLobbyCommand();
      return cmd;
    }

    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      LogSystem.Info("disconnectlobby");
      return false;
    }
  }
  /// <summary>
  ...
  internal class PublishFilterEventCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      ...
      LogSystem.Info("publishfilterevent:{0} {1}", evname, group);
      return false;
    }
  ...
  internal class PublishLogicEventCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      string evname = m_EventName.Value;
      string group = m_Group.Value;
      LogSystem.Info("publishlogicevent:{0} {1}", evname, group);
      return false;
    }
  ...
  internal class PublishGfxEventCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      string evname = m_EventName.Value;
      string group = m_Group.Value;
      LogSystem.Info("publishgfxevent:{0} {1}", evname, group);
      return false;
    }
  ...
  internal class SendGfxMessageCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      ...
      LogSystem.Info("sendmessage:{0} {1}", objname, msg);
      return false;
    }
  ...
  internal class SendGfxMessageWithTagCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      ...
      object[] args = arglist.ToArray();
      LogSystem.Info("sendmessagewithtag:{0} {1}", objtag, msg);
      return false;
    }
  ...
  internal class SendGfxMessageByIdCommand : AbstractStoryCommand
  {
    ...
    protected override bool ExecCommand(StoryInstance instance, long delta)
    {
      ...
      object[] args = arglist.ToArray();
      LogSystem.Info("sendmessagebyid:{0} {1}", objid, msg);
      return false;
    }
