skill(161601)
{
	section(2200)
	{
		...
		colliderdamage(200, 1500, true, true, 100, 16)
		{
			...
			bonecollider("hero/5_zhankuang/huoyanbaopocollider","Bone_Root", true);
		};
		...
		playsound(200, "skill1601", "Sound/zhankuang/zhankuang_sound", 1500, "Sound/zhankuang/zhankuang_huoyanbaopo_release", false);
		playsound(150, "skill1602", "Sound/zhankuang/zhankuang_sound", 1000, "Sound/zhankuang/ZK_Voice_HuoYan_01", false);
		playsound(1900, "skill1603", "Sound/zhankuang/zhankuang_sound", 1000, "Sound/zhankuang/zhankuang_huoyanbaopo_explosion", false);
...
skill(161602)
{
	section(300)
	{
		...
		gotosection(300, 3, 0);
		playsound(200, "skill1611", "Sound/zhankuang/zhankuang_sound", 1000, "Sound/zhankuang/zhankuang_huoyanzhuaqu_grab", false);
	};
	section(3000)
	{
		playsound(150, "skill1612", "Sound/zhankuang/zhankuang_sound", 2500, "Sound/zhankuang/ZK_Voice_HuoYan_02", false);
		...
		colliderdamage(100, 2900, true, true, 200, 14)
		{
		...
		playsound(0, "skill1613", "Sound/zhankuang/zhankuang_sound", 4000, "Sound/zhankuang/zhankuang_huoyanzhuaqu_run", false);
	...
	section(1533)
	{
		...
		grabtarget(560, false);
		areadamage(570, 0, 1.5, 0, 4, true)
		{
			stateimpact("kDefault", 16160205);
		};
		playsound(550, "skill1614", "Sound/zhankuang/zhankuang_sound", 1000, "Sound/zhankuang/ZK_Voice_HuoYan_03", false);
		playsound(0, "skill1615", "Sound/zhankuang/zhankuang_sound", 1000, "Sound/zhankuang/zhankuang_huoyanzhuaqu_crush", false);
