 ...
 */
  public class SkillLogicData : IData
  {
    ...
    public float CastTime;                        // 吟唱时间，单位：秒
    ...
    public int LevelUpCostType;                   // 技能升级扣除金钱类型
    public int LevelUpVigorType;                  // 技能升级扣除精力类型
 ...
 */
  public class ImpactLogicData : IData
  {
    ...
    public bool BreakParry;            // 是否能破格挡
    public List<int> TargetFigure;      // 目标体型
