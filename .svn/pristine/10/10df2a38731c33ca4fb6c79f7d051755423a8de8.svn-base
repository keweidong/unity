...
skill(400501)
{
  ...
  section(166)//第一段
  {
    ...
    //
    summonnpc(30, 101, "Monster_FX/YiNa/6_Mon_YiNa_FeiBiao_01", 400516, vector3(0, 0, 0));
    summonnpc(30, 101, "Monster_FX/YiNa/6_Mon_YiNa_FeiBiao_01", 400517, vector3(0, 0, 0));
    //
    //音效
