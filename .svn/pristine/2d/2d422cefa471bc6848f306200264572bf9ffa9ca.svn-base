skill(130301)
{
    ...
    section(1800)
	{
        ...
        sceneeffect("Hero_FX/6_Fashi/6_hero_fashi_xueqiu_03",1000,vector3(-0.2,1.5,3),1400);
        summonnpc(1600, 101, "Hero_FX/6_Fashi/6_hero_fashi_xueqiu_02", 130312, vector3(0,0,0))
        {
            signforskill(301);
        };
        summonnpc(1600, 101, "Hero/6_fashi/base_ef", 130314, vector3(0,0,0))  
        {
            signforskill(302);
        };
	...
	{
        animation("fashi_xueqiu_01_03"); 
        sceneeffect("Hero_FX/6_Fashi/6_hero_fashi_xueqiu_03",1000,vector3(-0.2,1.5,7),1400);
        summonnpc(1600, 101, "Hero_FX/6_Fashi/6_hero_fashi_xueqiu_02", 130313, vector3(0,0,0))
        {
            signforskill(301);
        };  
        summonnpc(1600, 101, "Hero/6_fashi/base_ef", 130315, vector3(0,0,0))
        {
            signforskill(302);
        };
        gotosection(1800, 3, 0);
