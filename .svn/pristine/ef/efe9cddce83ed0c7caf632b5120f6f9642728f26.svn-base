...
namespace DashFire
{
  ...
  {
    public DataDictionaryMgr<ExpeditionTollgateConfig> ExpeditionTollgateConfigMgr
    {
      get { return m_ExpeditionTollgateConfigMgr; }
    }
    public ExpeditionTollgateConfig GetDataById(int id)
    {
      return m_ExpeditionTollgateConfigMgr.GetDataById(id);
    }
