...
namespace DashFire
{
  public class ChineseLastName : IData
  {
    public int m_Id = 0;
  ...
  public class ChineseLastNameProvider
  {
    ...
    public static ChineseLastNameProvider Instance
    {
      get { return s_Instance; }
    }
    private static ChineseLastNameProvider s_Instance = new ChineseLastNameProvider();
  }
}
