...
namespace DashFire
{
  public class CuteLastName : IData
  {
    public int m_Id = 0;
  ...
  public class CuteLastNameProvider
  {
    ...
    public static CuteLastNameProvider Instance
    {
      get { return s_Instance; }
    }
    private static CuteLastNameProvider s_Instance = new CuteLastNameProvider();
  }
}
