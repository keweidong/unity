  ...
  public static class LogicSystem
  {
    ...
    public static void LogicLog(string format, params object[] args)
    {
        ...
        for (int i = 0; i < args.Length; i++)
        {
            ...
            UnityEngine.Debug.Log(".." + format + "..." + s);
    ...
    public static void UpdateRandomLoadingTip()
    {
      GfxSystem.Instance.UpdateRandomLoadingTip();
    }
    ...
    public static void NotifyGfxBreakSkill(GameObject obj, DashFire.SkillCategory category)
    {
      if (null != obj) {
        SharedGameObjectInfo info = GfxSystem.Instance.GetSharedGameObjectInfo(obj);
        if (null != info) {
    ...
    public static void NotifyGfxSummonNpc(GameObject obj, int owner_skillid, int npc_type_id, string model, int skillid, int ailogicid,bool followsummonerdead,
                                          float pos_x, float pos_y, float pos_z, string aiparamstr, int signforskill)
    {
      SharedGameObjectInfo info = GfxSystem.Instance.GetSharedGameObjectInfo(obj);
      if (null != info) {        
        if (null != GfxSystem.Instance.GameLogicNotification) {
          QueueLogicAction(GfxSystem.Instance.GameLogicNotification.OnGfxSummonNpc, info.m_LogicObjectId, owner_skillid, npc_type_id, model, skillid, ailogicid,
            followsummonerdead, pos_x, pos_y, pos_z, aiparamstr, signforskill);
        }
      }
    }
    ...
    public static void NotifyGfxForbidNextSkill(int LogicId)
    {
      QueueLogicAction(GfxSystem.Instance.GameLogicNotification.OnGfxForbidNextSkill, LogicId);
    }
