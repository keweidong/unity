skill(160301)
{
	section(900)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_shanshen_01_01", 500, "Bone_Root", 33);
...
skill(160302)
{
	section(1466)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_shanshen_02_01", 1000, "Bone_Root", 180);
