skill(161101)
{
	section(133)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_dafengche_01",3000,"Bone_Root",100);
	...
	section(1490)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_dafengche_02",1000,"Bone_Root",1400);
	};
	section(500)
	{
		//帧1
