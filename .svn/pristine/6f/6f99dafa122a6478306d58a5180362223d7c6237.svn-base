...
//    charactereffect("Monster_FX/Demo_01/01_Bluelf/6_Mon_Bluelf_SwordS_01", 4000, "ef_body", 10);
    ...
    summonnpc(840, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390012, vector3(0, 0, 0));
    summonnpc(840, 101, "Monster/Campaign_Wild/02_Blof/5_Mon_Blof_02_w_01", 390013, vector3(0, 0, 0));
