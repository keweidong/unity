...
namespace DashFire {
  ...
  {
    public DataDictionaryMgr<LegacyLevelupConfig> LegacyLevelupConfigMgr
    {
      get
      {
        return m_LegacyLevelupConfigMgr;
      }
    }
    public LegacyLevelupConfig GetDataById(int id)
    {
      return m_LegacyLevelupConfigMgr.GetDataById(id);
    }
