  ...
  internal class Serialize
  {
    internal static bool Init()
    {
      if (!s_Inited) {
        ...
        RegisterIDName((int)MessageDefine.Msg_RC_ChangeScene, typeof(Msg_RC_ChangeScene));
        ...
        RegisterIDName((int)MessageDefine.Msg_CR_SyncCharacterGfxState, typeof(Msg_CR_SyncCharacterGfxState));
        RegisterIDName((int)MessageDefine.Msg_CR_SummonPartner, typeof(Msg_CR_SummonPartner));
        RegisterIDName((int)MessageDefine.Msg_CRC_SummonNpc, typeof(Msg_CRC_SummonNpc));
        RegisterIDName((int)MessageDefine.Msg_RC_SyncNpcOwnerId, typeof(Msg_RC_SyncNpcOwnerId));
        RegisterIDName((int)MessageDefine.Msg_CR_GmCommand, typeof(Msg_CR_GmCommand));
        RegisterIDName((int)MessageDefine.Msg_RC_DropNpc, typeof(Msg_RC_DropNpc));
        RegisterIDName((int)MessageDefine.Msg_CR_PickUpNpc, typeof(Msg_CR_PickUpNpc));
      }
      return true;
    }
    ...
    {
      int id;
      if (s_DicIDName.TryGetValue(msg.GetType(), out id)) {
