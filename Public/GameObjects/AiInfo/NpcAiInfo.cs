...
namespace DashFire
{
  ...
  public class AiData_Npc_Bluelf : AiData_PveNpc_General {
    ...
    {
      get { return m_LastEscapeTime; }
      set { m_LastEscapeTime = value; }
    }
    ...
    private long m_LastEscapeTime = 0;
  ...
  public class AiData_Npc_ActionDrive : AiData_PveNpc_General {
    ...
    {
      get { return m_MaxControlTime; }
      set { m_MaxControlTime = value; }
    }
    public List<AiActionInfo> Actions
    {
      get { return m_Actions; }
    }
    public List<AiActionInfo> MaxControlEventActions
    {
      get { return m_MaxControlEventActions; }
      set { m_MaxControlEventActions = value; }
    }
    public DashFire.AiActionInfo ActiveAction
    {
      get { return m_ActiveAction; }
      set { m_ActiveAction = value; }
    }
    public Stack<AiActionInfo> ActionStack
    {
      get { return m_ActionStack; }
    }
    public DashFire.AiConfig Config
    {
      get { return m_Config; }
      set { m_Config = value; }
    }
    ...
    private long m_LastUseSkillTime = 0;
    private long m_ControlTime = 0;
    private long m_MaxControlTime = 0;
    private List<AiActionInfo> m_Actions = new List<AiActionInfo>();
    private List<AiActionInfo> m_MaxControlEventActions = new List<AiActionInfo>();
    private AiConfig m_Config = null;
    private AiActionInfo m_ActiveAction = null;
    private Stack<AiActionInfo> m_ActionStack = new Stack<AiActionInfo>();
  }
}
