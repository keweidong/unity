...
namespace DashFire
{
  ...
  {
    public DataDictionaryMgr<ExpeditionMonsterConfig> ExpeditionMonsterConfigMgr
    {
      get { return m_ExpeditionMonsterConfigMgr; }
    }
    public ExpeditionMonsterConfig GetDataById(int id)
    {
      return m_ExpeditionMonsterConfigMgr.GetDataById(id);
    }
    public int GetDataCount()
    {
      return m_ExpeditionMonsterConfigMgr.GetDataCount();
    }
