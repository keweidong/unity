...
namespace DashFire
{
  ...
  public class AppendAttributeConfig : IData
  {
    ...
    {
      float base_value = GetAddHpMax1(refVal, refLevel);
      return base_value + GetAddHpMax2(base_value + refVal, refLevel);
    }
    public float GetAddRageMax(float refVal, int refLevel)
    {
      float base_value = GetAddRageMax1(refVal, refLevel);
      return base_value + GetAddRageMax2(base_value + refVal, refLevel);
    }
    public float GetAddEpMax(float refVal, int refLevel)
    {
      float base_value = GetAddEpMax1(refVal, refLevel);
      return base_value + GetAddEpMax2(base_value + refVal, refLevel);
    }
    public float GetAddAd(float refVal, int refLevel)
    {
      float base_value = GetAddAd1(refVal, refLevel);
      return base_value + GetAddAd2(base_value + refVal, refLevel);
    }
    public float GetAddADp(float refVal, int refLevel)
    {
      float base_value = GetAddADp1(refVal, refLevel);
      return base_value + GetAddADp2(base_value + refVal, refLevel);
    }
    public float GetAddMDp(float refVal, int refLevel)
    {
      float base_value = GetAddMDp1(refVal, refLevel);
      return base_value + GetAddMDp2(base_value + refVal, refLevel);
    }
    public float GetAddCri(float refVal, int refLevel)
    {
      float base_value = GetAddCri1(refVal, refLevel);
      return base_value + GetAddCri2(base_value + refVal, refLevel);
    }
    public float GetAddPow(float refVal, int refLevel)
    {
      float base_value = GetAddPow1(refVal, refLevel);
      return base_value + GetAddPow2(base_value + refVal, refLevel);
    }
    public float GetAddBackHitPow(float refVal, int refLevel)
    {
      float base_value = GetAddBackHitPow1(refVal, refLevel);
      return base_value + GetAddBackHitPow2(base_value + refVal, refLevel);
    }
    public float GetAddCrackPow(float refVal, int refLevel)
    {
      float base_value = GetAddCrackPow1(refVal, refLevel);
      return base_value + GetAddCrackPow2(base_value + refVal, refLevel);
    }
    public float GetAddHpRecover(float refVal, int refLevel)
    {
      float base_value = GetAddHpRecover1(refVal, refLevel);
      return base_value + GetAddHpRecover2(base_value + refVal, refLevel);
    }
    public float GetAddEpRecover(float refVal, int refLevel)
    {
      float base_value = GetAddEpRecover1(refVal, refLevel);
      return base_value + GetAddEpRecover2(base_value + refVal, refLevel);
    }
    public float GetAddSpd(float refVal, int refLevel)
    {
      float base_value = GetAddSpd1(refVal, refLevel);
      return base_value + GetAddSpd2(base_value + refVal, refLevel);
    }
    public float GetAddFireDam(float refVal, int refLevel)
    {
      float base_value = GetAddFireDam1(refVal, refLevel);
      return base_value + GetAddFireDam2(base_value + refVal, refLevel);
    }
    public float GetAddFireErd(float refVal, int refLevel)
    {
      float base_value = GetAddFireErd1(refVal, refLevel);
      return base_value + GetAddFireErd2(base_value + refVal, refLevel);
    }
    public float GetAddIceDam(float refVal, int refLevel)
    {
      float base_value = GetAddIceDam1(refVal, refLevel);
      return base_value + GetAddIceDam2(base_value + refVal, refLevel);
    }
    public float GetAddIceErd(float refVal, int refLevel)
    {
      float base_value = GetAddIceErd1(refVal, refLevel);
      return base_value + GetAddIceErd2(base_value + refVal, refLevel);
    }
    public float GetAddPoisonDam(float refVal, int refLevel)
    {
      float base_value = GetAddPoisonDam1(refVal, refLevel);
      return base_value + GetAddPoisonDam2(base_value + refVal, refLevel);
    }
    public float GetAddPoisonErd(float refVal, int refLevel)
    {
      float base_value = GetAddPoisonErd1(refVal, refLevel);
      return base_value + GetAddPoisonErd2(base_value + refVal, refLevel);
    }
    public float GetAddWeight(float refVal, int refLevel)
    {
      float base_value = GetAddWeight1(refVal, refLevel);
      return base_value + GetAddWeight2(base_value + refVal, refLevel);
    }
    public float GetAddRps(float refVal, int refLevel)
    {
      float base_value = GetAddRps1(refVal, refLevel);
      return base_value + GetAddRps2(base_value + refVal, refLevel);
    }
    public float GetAddAttackRange(float refVal, int refLevel)
    {
      float base_value = GetAddAttackRange1(refVal, refLevel);
      return base_value + GetAddAttackRange2(base_value + refVal, refLevel);
    }
  ...
  public class AppendAttributeConfigProvider {
    public DataDictionaryMgr<AppendAttributeConfig> AppendAttributeConfigMgr
    {
      get { return m_AppendAttributeConfigMgr; }
    }
