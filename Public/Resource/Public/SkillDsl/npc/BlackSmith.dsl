...
skill(300605)
{
  section(2233)
  {
    ...
    areadamage(1723, 0, 0.5, 2.4, 3, true) {
...
skill(300606)
{
  section(2033)
  {
    movecontrol(true);
    animation("Skill_01");
    findmovetarget(0, vector3(0,0,0),2,60,0.5,0.5,0,-2);
    startcurvemove(1160, true, 0.1, 0, 0, 20, 0, 0, 0);
    ...
    areadamage(1250, 0, 0.5, 2, 2.4, false) {
