skill(161201)
{
	section(900)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_Hero_zhankuang_zhuang", 1000, "Bone_Root", 200);

		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_shanshen_01_01", 1000, "Bone_Root", 110);
...
skill(161202)
{
	section(1050)
	{
		...
		charactereffect("Hero_FX/5_zhankuang/5_hero_zhankuang_jianchong_01_01",1000,"Bone_Root",350);
