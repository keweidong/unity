	...
	local
  {
    ...
    publishgfxevent("ge_mpve_progress","ui",@Count,5);//修改界面击杀boss数显示
		...
		if(2==@Count)//打第3波怪的时候
	  {
		    publishgfxevent("pve_boss_enter","ui_effect","即将来袭");
		  	wait(5000);
		    @RollBoss3=rndfromlist(intlist("1042 1045 1055 1049"));//roll第3个怪
		     wait(10);
		...
		if(3==@Count)//打第4波怪的时候
	  {
		    publishgfxevent("pve_boss_enter","ui_effect","即将来袭");
		  	wait(5000);
		    @RollBoss4=rndfromlist(intlist("1048 1043 1041 1054"));//roll第4个怪
		     wait(10);
		...
		if(4==@Count)//打第5波怪的时候
	  {
	  	  publishgfxevent("pve_boss_enter","ui_effect","即将来袭");
		  	wait(5000);
	  	  @RollBoss5=rndfromlist(intlist("1047"));//roll第5个怪
	  	   wait(10);
