...
namespace DashFire
{
  ...
  public class ResUpdateHandler
  {
    ...
    public delegate ResAsyncInfo EventCacheResByConfig(int levelId);
    ...
    public delegate int EventGetUpdateError();
    ...
    public static EventGetUpdateError HandleGetUpdateError;
    #endregion
    ...
    public static ResAsyncInfo CacheResByConfig(int levelId)
    {
      if (HandleCacheResByConfig != null) {
        return HandleCacheResByConfig(levelId);
      }
      return null;
    }
    ...
    public static int GetUpdateError()
    {
      if (HandleGetUpdateError != null) {
        return HandleGetUpdateError();
      }
      return 0;
    }
  }
